...
- Assume that typescript, vite, tailwind, Biome JS, and all codebase configuration is working. If there is a bug, it is more likely your code than the codebase configuration.
